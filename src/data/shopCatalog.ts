...
export const BOARD_THEMES: ShopItem[] = [
  ...
  },
  {
    ...
    price: 0,
    rarity: 'legendary',
    preview: { boardColor: '#3d2a0a' },
    collection: 'Career Exclusive',
    description: 'Warm amber sand at sunrise',
  },
  {
    id: 'lake_effect',
    name: 'Lake Effect',
    price: 0,
    rarity: 'legendary',
    preview: { boardColor: '#1a2a3d' },
    collection: 'Career Exclusive',
    description: 'Cold steel blue, Cleveland winter',
  },
  {
    id: 'liberty_bell',
    name: 'Liberty Bell',
    price: 0,
    rarity: 'legendary',
    preview: { boardColor: '#2a2a3a' },
    collection: 'Career Exclusive',
    description: 'Weathered bronze and silver',
  },
  {
    id: 'pacific_storm',
    name: 'Pacific Storm',
    price: 0,
    rarity: 'legendary',
    preview: { boardColor: '#0a2a2a' },
    collection: 'Career Exclusive',
    description: 'Dark teal, rain-streaked',
  },
  {
    id: 'crown_court',
    name: 'Crown Court',
    ...
    preview: { boardColor: '#3d0a0a' },
    collection: 'Career Exclusive',
    description: 'Royal crimson and white trim',
  },
];
...
export const PIECE_THEMES: ShopItem[] = [
  ...
  },
  {
    ...
    price: 0,
    rarity: 'legendary',
    preview: { p1Color: '#ff4500', p2Color: '#ff8c00' },
    collection: 'Career Exclusive',
    description: 'Burning orange and red',
  },
  {
    id: 'gold_chain',
    name: 'Gold Chain',
    price: 0,
    rarity: 'legendary',
    preview: { p1Color: '#ffd700', p2Color: '#b8860b' },
    collection: 'Career Exclusive',
    description: 'Heavy gold and dark amber',
  },
];
