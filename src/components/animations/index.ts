/**
 * Drop4 Micro-Animation Toolkit
 *
 * Reusable animation primitives built on Reanimated 3.
 * Import from '@/components/animations' across all screens.
 *
 * Components:
 *   PressScale      — Tactile press feedback (scale + haptics)
